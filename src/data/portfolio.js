...
export const items = [
  ...
  { id: 'writing-dino-q-learning', collection: 'Blog', title: 'Teaching a Pixel Dinosaur with Q-learning', category: 'Reinforcement learning', status: 'Article', publicationStatus: 'published', summary: 'How a small tabular agent learns to move, turn and jump from local vision, shaped rewards and repeated episodes.', path: '/writing/dino-q-learning' },
